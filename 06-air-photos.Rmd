...
Select one of the forest or urban air photos and place the dot-grid on top of the air photo. Take a photo of the air photo and dot grid. 

Select 3 irregularly shaped features in the photo, these could be lakes, cut-blocks, parks, property lines etc... 

**Step 4:** Use the dot-grid to estimate how many cells cover each feature. Then look up the photo scale on the GIC website. Use the following example to help you calculate the ground area of each feature in m2. 
...
**Step 5:** Record the ground area of each feature. On the photo you took of the air photo and dot grid use a photo editing program (ie MS Paint) to outline the features you chose. Add labels A,B,C to each feature. Include the image in your final deliverables along with the estimated ground area of each feature and its associated label.   
...
##### Q12: Take a screenshot of the historic air photo overlaying the modern imagery (adjust the transparency of the air photo so the basemap can be seen underneath). In 1-2 sentences briefly describe the change taking place in the screenshot. {.unnumbered} 