...
author <- yml_content[["climate-spatial-data"]][["author"]]
```
# Introduction to spatial data and map projections {#climate-spatial-data}
...
-   Understand differences between raster and vector data types
