...
# Geodatabases, data handling, and mapping {#geodatabase-management}
...
```{r 02-layout, echo = FALSE, out.width= "100%"}
...
```{r 02-elements, out.width= "100%", echo = FALSE}
...
```{r 02-example, out.width= "100%", echo = FALSE}
...
```{r 02-Inset, out.width= "100%", echo = FALSE}
