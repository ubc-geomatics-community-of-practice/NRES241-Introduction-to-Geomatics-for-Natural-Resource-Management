...
section is meant to inform you of the likely hazards and how to stay safe.
...
GNSS data near cliffs or on steep terrain. Finally, ensure that you will have good cell phone coverage in case of an emergency.
...
your park. Always use designated crosswalks and do not look at your phone when walking near stopped or moving vehicles. 
...
**INCLUDE THE MAP IN YOUR FINAL DELIVERABLES**

##### Q1: Provide a description of each reference point - what is it? {.unnumbered}
...
**On the Charts tab take a screenshot of the Number of Satellites and Iono Information charts - INCLUDE IN FINAL DELIVERABLES**

##### Q2: Use these plots to determine the ideal time to collect GNSS points and briefly explain why. {.unnumbered}
...
**INCLUDE PICTURES OF ALL YOUR REFERENCE POINTS (IN THE FIELD) WITH YOUR FINAL DELIVERABLES**
...
**TAKE A SCREENSHOT OF YOUR REFERNCE POINTS AND OBSERVED POINTS IN ARCGIS PRO AND INCLUDE IN YOUR DELIVERABLES**
...
##### Q3: Is there a noticeable difference in accuracy between your placemarks? Why do you think this is? {.unnumbered}
...
The resulting value represents how precise the GNSS measurements were – a lower value represents greater accuracy. 

##### Q4: Is there a noticeable difference in precision between your placemarks? Why do you think this is? {.unnumbered}

##### Q5: In 300 words or less, discuss potential errors and what may have affected accuracy and precision – be sure to reflect on the validity of the “True” values. {.unnumbered}