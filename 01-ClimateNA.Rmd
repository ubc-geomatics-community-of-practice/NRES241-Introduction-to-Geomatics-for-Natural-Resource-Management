...
##### Q2. Zoom in to the UBC Vancouver campus, what is the MAT and MAP at this location? (You do not need to click on the exact same point shown below, but make sure to click somewhere on campus). {.unnumbered}
...
##### Q3. What is the Geographic Coordinate System of the layer? What is the Angular Unit? {.unnumbered}
...
## Task 3: Working with raster data and map projections {.unnumbered}
...
##### Q4. From the IPCC Sixth Assessment Report what does the SSP2-4.5 scenario represent? Answer in 2-3 sentences. {.unnumbered}  
...
##### Q6: For each scenario idenitfy the best map projection: 1) Comparing the area of different provinces, 2) Calculating the direction and distance between two cities, 3) Mapping the shape of the northern coastline? {.unnumbered}
...
##### Q8: What is the minimum and maximum change in MAP (in units of mm)? {.unnumbered} 
