...
```{r 05-ndvi, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/05/05-ndvi.png")
```
...
```{r 05-ndbi, out.width= "75%", echo = FALSE}
    knitr::include_graphics("images/05/05-ndbi.png")
```
